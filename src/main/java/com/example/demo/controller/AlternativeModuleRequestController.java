...
public class AlternativeModuleRequestController {
	...
	public String updateRequest(@RequestParam int rid, @RequestParam String status, @RequestParam String decision, @RequestParam String alterMcode[], @RequestParam String offeringSem[]) throws UnsupportedEncodingException, MessagingException {
		
		return alterService.updateRequest(rid, status, decision, alterMcode, offeringSem);
	}
}
